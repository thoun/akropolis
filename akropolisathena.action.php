 ...
 * -----
 *
 * akropolisathena.action.php
 *
 * AkropolisAthena main action entry point
 *
 *
 ...
 * this.ajaxcall( "/akropolisathena/akropolisathena/myAction.html", ...)
 *
 */

class action_akropolisathena extends APP_GameAction
{
  ...
  public function __default()
  {
    if (self::isArg('notifwindow')) {
      ...
      $this->view = 'akropolisathena_akropolisathena';

...
var PlayerTable = /** @class */ (function () {
  function PlayerTable(game, player) {
    ...
    var html = '\n        <div id="player-table-'
      ...
      .concat(player.color, ';">')
      .concat(player.name, '</span>\n            </div>\n            <div id="player-table-')
      .concat(this.playerId, '-city" class="city"></div>\n        </div>\n        ');
  ...
  PlayerTable.prototype.createGrid = function (grid) {
    ...
    Object.keys(grid).forEach(function (x) {
      return Object.keys(grid[x]).forEach(function (y) {
        return Object.keys(grid[x][y]).forEach(function (z) {
          _this.createHex(Number(x), Number(y), Number(z), grid[x][y][z]);
        });
      });
    });
  };
  PlayerTable.prototype.createHex = function (x, y, z, type) {
    var _a;
    var typeArray = type.split('-');
    var type = typeArray[0];
    var plaza = typeArray[1] === 'plaza';
    dojo.place(
      '<div class="temp-hex" style="--x: '
        .concat(x, '; --y: ')
        .concat(y, '; --z: ')
        .concat(z, ';" data-type="')
        .concat(type, '" data-plaza="')
        .concat(plaza, '">')
        .concat(type)
        .concat(plaza ? '<br>('.concat((_a = typeArray[1]) !== null && _a !== void 0 ? _a : '', ')') : '', '<br>')
        .concat(x, ', ')
        .concat(y, ', ')
        .concat(z, '</div>'),
      document.getElementById('player-table-'.concat(this.playerId, '-city'))
    );
  };
  return PlayerTable;
})();
...
var Akropolis = /** @class */ (function () {
  ...
  Akropolis.prototype.createPlayerPanels = function (gamedatas) {
    ...
    Object.values(gamedatas.players).forEach(function (player) {
      ...
      // Stones counter
      dojo.place(
        '<div class="counters">\n                <div id="stones-counter-wrapper-'
          .concat(
            player.id,
            '" class="stones-counter">\n                    <div class="stone score-icon"></div> \n                    <span id="stones-counter-'
          )
      ...
      for (var i = 1; i <= 5; i++) {
        dojo.place(
          '<div class="counters">\n                    <div id="color-points-'
            .concat(i, '-counter-wrapper-')
            .concat(player.id, '" class="color-points-counter">\n                        <div class="score-icon" data-type="')
            .concat(i, '"></div> \n                        <span id="hexes-')
            .concat(i, '-counter-')
            .concat(
              player.id,
              '"></span>\n                        <span class="multiplier">\u00D7</span>\n                        <div class="score-icon star" data-type="'
            )
            .concat(i, '"></div> \n                        <span id="stars-')
            .concat(i, '-counter-')
            .concat(
              player.id,
              '"></span>\n                        <span class="multiplier">=</span>\n                        <span id="color-points-'
            )
            .concat(i, '-counter-')
            .concat(player.id, '"></span>\n                    </div>\n                </div>'),
          'player_board_'.concat(player.id)
    ...
    this.setTooltipToClass(
      'color-points-counter',
      _('Score for this color (number of valid districts multiplied by matching stars)')
    );
  };
  ...
  Akropolis.prototype.addHelp = function () {
    ...
    document.getElementById('akropolis-help-button').addEventListener('click', function () {
